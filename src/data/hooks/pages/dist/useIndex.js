...
function useIndex() {
    var _a = react_1.useState([]), listaPets = _a[0], setListaPets = _a[1], _b = react_1.useState(null), petSelecionado = _b[0], setPetSelecionado = _b[1], _c = react_1.useState(""), email = _c[0], setEmail = _c[1], _d = react_1.useState(""), valor = _d[0], setValor = _d[1], _e = react_1.useState(""), mensagem = _e[0], setMensagem = _e[1];
    react_1.useEffect(function () {
        apiServices_1.ApiServices.get('/pets')
